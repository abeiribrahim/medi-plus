...
<html class="no-js" lang="zxx">
    ...
    <body>
		...
		<ul class="pro-features">
			...
			<li>2+ premade MEDI-PLUS pages</li>
			<li>20+ html pages</li>
					...
					<div class="inner">
						<div class="row">
							<div class="col-lg-3 col-md-3 col-12">
								<!-- Start Logo -->
								<div class="logo">
									<a href="index"><img src="{{asset('assets/img/logo.png')}}" alt="#"></a>
								</div>
								<!-- End Logo -->
								<!-- Mobile Nav -->
							...
							<div class="col-lg-7 col-md-9 col-12">
								...
								<div class="main-menu">
									<nav class="navigation">
										<ul class="nav menu">
											<li class="active"><a href="#">MEDI-PLUS <i class="icofont-rounded-down"></i></a>
												<ul class="dropdown">
													<li><a href="index">MEDI-PLUS Page 1</a></li>
												</ul>
											</li>
				...
				<div class="row">
					<div class="col-lg-3 col-md-6 col-12">
						...
						<div class="single-fun">
							<i class="icofont icofont-MEDI-PLUS"></i>
							<div class="content">
					...
					<div class="col-lg-12 col-12">
						<div class="owl-carousel portfolio-slider">
							<div class="single-pf">
								...
								<a href="portfolio-details" class="btn">View Details</a>
							</div>
							<div class="single-pf">
				...
				<div class="row ">
					<div class="col-lg-6  col-12">
						...
						<div class="subscribe-text ">
							...
							<p class="">Cu qui soleat partiendo urbanitas. Eum aperiri indoctum eu,<br> MEDI-PLUSro alterum.</p>
						</div>
						<!-- End Newsletter Form -->
					</div>
					<div class="col-lg-6  col-12">
						...
						<div class="col-lg-3 col-md-6 col-12">
							<div class="single-footer f-link">
								...
								<div class="row">
									<div class="col-lg-6 col-md-6 col-12">
										<ul>
											<li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i>MEDI-PLUS</a></li>
